...
Команды (состояние стека до >> состояние стека после)
...
* Литералы записываются в память данных и обрабатываются в момент выполнения программы.
...
* терм - слово программы, преобразованное в формат машинной команды
...
1. [translator.py:fix_interrupt](translator.py#L326): перераспределяет термы, относящиеся к обработчикам прерываний, и
   термы обычного кода, упорядочивая их так, чтобы прерывания обрабатывались первыми, и обновляет точку входа на
   начало прерывания, если оно определено.
2. Для каждого терма в списке terms функция [translator.py:term2opcodes](translator.py#L229) вызывается для
   преобразования
   терма в список кодов операций
...
В результате сопоставления термов `IF`, `DO`, `:`, `ELSE` и variable, allot получается список операций, некоторые из
которых могут ссылаться на другие. Чтобы преобразовать это в последовательный список термов, адреса в операциях
заменяются машинными командами. Для этого используются абсолютная и относительные адресации.

Функция [translator.py:fix_addresses](translator.py#L270) реализует этот процесс.

Целочисленные литералы преобразуются в машинную команду `PUSH <int>`. Строковые литералы вида `." string"`
преобразуются в последовательность команд, которые выполняют следующие действия:
...
Реализовано функцией [translator.py:fix_literal](translator.py#L184)
...
* `Data Memory` - память данных, либо чтение, либо запись
* `Instruction Memory` - память команд
* `Data Stack` - стек для хранения данных программы
...
TICK:    1 | COMMAND: ret   | PC:  13 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    2 | COMMAND: push  | PC:  14 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    3 | COMMAND: push  | PC:  14 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    4 | COMMAND: push  | PC:  14 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [0, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    5 | COMMAND: push  | PC:  15 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [0, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    6 | COMMAND: push  | PC:  15 | PS_REQ: 0 | PS_STATE: 1 | SP:   6 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [0, 0, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    7 | COMMAND: push  | PC:  15 | PS_REQ: 0 | PS_STATE: 1 | SP:   6 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [512, 0, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    8 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:       0 | TOS: [512, 0, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:    9 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:       0 | TOS: [512, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   10 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   11 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   12 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   13 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   14 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:       0 | TOS: [512, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   15 | COMMAND: load  | PC:  18 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [0, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   16 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   17 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   18 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   19 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   20 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:       0 | TOS: [512, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   21 | COMMAND: load  | PC:  18 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [0, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   22 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   23 | COMMAND: store | PC:  16 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   24 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   4 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   25 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [1024, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   26 | COMMAND: push  | PC:  17 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:       0 | TOS: [512, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
TICK:   27 | COMMAND: load  | PC:  18 | PS_REQ: 0 | PS_STATE: 1 | SP:   5 | I:   4 | MEDIUM:    1024 | DATA_MEMORY[TOP]:    2048 | TOS: [0, 1024, 1024, 1024, 1024] | RETURN_TOS: [1024, 1024, 1024] 
Output: hello
