...
| rpop       | 1             | перенос значения из стека возврата в стек данных                           |
| call addr  | 1             | вызов процедуры по адресу addr                                             |
| jmp addr   | 1             | перейти по адресу addr                                                     |
| zjmp addr  | 1             | перейти по адресу addr, если на вершине стека 0, убирает значение со стека |
